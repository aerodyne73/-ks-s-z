...
export const DEMO_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: { label: 'Site A', cat: Category.STYLES },
      },
      {
      ...
      },
      {
        ...
        data: { label: "Site C", cat: Category.STYLES },
      },
      {
        path: 'satellite-map',
        component: SatelliteMapComponent,
        data: { label: 'Site D', cat: Category.STYLES },
      },
      {
      ...
      },
      {
        ...
        data: { label: 'Site B', cat: Category.LAYERS },
      },
      {
        path: 'toggle-layers',
        component: ToggleLayersComponent,
        data: { label: 'Site C', cat: Category.LAYERS },
      },
      {
        path: '3d-buildings',
        component: Display3dBuildingsComponent,
        data: { label: 'Site D', cat: Category.LAYERS },
      },
      {
        path: 'cluster',
        component: ClusterComponent,
        data: { label: 'Project C', cat: Category.LAYERS },
      },
      {
        path: 'heatmap',
        component: HeatMapComponent,
        data: { label: 'Site A', cat: Category.LAYERS },
      },
      {
        path: 'geojson-line',
